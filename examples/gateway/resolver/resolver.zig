...
const MAX_SERVICES = resolver_types.MAX_SERVICES;
const MAX_SECRETS = resolver_types.MAX_SECRETS;
const MAX_NAME_LEN = resolver_types.MAX_NAME_LEN;
const MAX_CERT_SIZE = resolver_types.MAX_CERT_SIZE;
const ResolverError = resolver_types.ResolverError;
