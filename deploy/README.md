...
| `deploy/examples/netbird/openwrt/deploy-router.sh` | Build and deploy the NetBird/OpenWrt router bundle, including `netbird_proxy` and router-side install/update steps |
